...
export async function runE2ETests() {
  ...
  const doctorAuth = (await loginDoctorRes.json()) as any;
  ...
  const pharmacistAuth = (await loginPharmacistRes.json()) as any;
  ...
  const adminAuth = (await loginAdminRes.json()) as any;
  ...
  const todayQueuesJson = (await todayQueuesRes.json()) as any;
  ...
  const prescriptionJson = (await prescriptionRes.json()) as any;
  ...
  const allPrescriptionsJson = (await listPrescriptionsRes.json()) as any;
  ...
  const statsJson = (await adminStatsRes.json()) as any;
